...
public interface JobsPlusToolsItems {
    ...
    RegistrySupplier<Item> GOLDEN_TROWEL = item(JobsPlusTools.getId("golden_trowel"), p -> new TrowelItem(ToolMaterial.GOLD, -2, -0.5F, p.component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.MULTI_BLOCK_PLACER_MODE.getId(), 0, List.of(0, 1, 2, 3)))));
    ...
    RegistrySupplier<Item> DIAMOND_TROWEL = item(JobsPlusTools.getId("diamond_trowel"), p -> new TrowelItem(ToolMaterial.DIAMOND, -3, 0.0F, p.component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.MULTI_BLOCK_PLACER_MODE.getId(), 0, List.of(0, 1, 2, 3)))));
