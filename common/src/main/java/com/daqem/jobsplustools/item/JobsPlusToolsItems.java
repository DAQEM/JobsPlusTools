...
public interface JobsPlusToolsItems {
    ...
    RegistrySupplier<Item> WOODEN_HARVESTER = item(JobsPlusTools.getId("wooden_harvester"), p -> new HarvesterItem(ToolMaterial.WOOD, 0, -3.0F, p.component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.CROP_REPLACER_MODE.getId(), 0, List.of(0)))));
    ...
    RegistrySupplier<Item> STONE_HARVESTER = item(JobsPlusTools.getId("stone_harvester"), p -> new HarvesterItem(ToolMaterial.STONE, -1, -2.0f, p.component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.CROP_REPLACER_MODE.getId(), 0, List.of(0)))));
    ...
    RegistrySupplier<Item> COPPER_HARVESTER = item(JobsPlusTools.getId("copper_harvester"), p -> new HarvesterItem(ToolMaterial.COPPER, -1, -2.0f, p.component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.CROP_REPLACER_MODE.getId(), 0, List.of(0)))));
    ...
    RegistrySupplier<Item> IRON_HARVESTER = item(JobsPlusTools.getId("iron_harvester"), p -> new HarvesterItem(ToolMaterial.IRON, -2, -1.0f, p.component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.CROP_REPLACER_MODE.getId(), 0, List.of(0, 1)))));
    ...
    RegistrySupplier<Item> GOLDEN_HARVESTER = item(JobsPlusTools.getId("golden_harvester"), p -> new HarvesterItem(ToolMaterial.GOLD, -2, -0.5F, p.component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.CROP_REPLACER_MODE.getId(), 0, List.of(0, 1)))));
    ...
    RegistrySupplier<Item> DIAMOND_HARVESTER = item(JobsPlusTools.getId("diamond_harvester"), p -> new HarvesterItem(ToolMaterial.DIAMOND, -3, 0.0F, p.component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.CROP_REPLACER_MODE.getId(), 0, List.of(0, 1, 2)))));
    ...
    RegistrySupplier<Item> NETHERITE_HARVESTER = item(JobsPlusTools.getId("netherite_harvester"), p -> new HarvesterItem(ToolMaterial.NETHERITE, -4, 0.0F, p.fireResistant().component(JobsPlusToolsDataComponentTypes.MODE_ITEM_COMPONENT.get(), new ModeItemComponent(IModeType.CROP_REPLACER_MODE.getId(), 0, List.of(0, 1, 2)))));
